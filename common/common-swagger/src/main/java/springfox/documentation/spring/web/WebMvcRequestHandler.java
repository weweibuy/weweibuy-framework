...
public class WebMvcRequestHandler implements RequestHandler {
    ...
    public PatternsRequestCondition getPatternsCondition() {
        ...
        String[] strings = new String[patterns.size()];
        String[] array = patterns.toArray(strings);

        org.springframework.web.servlet.mvc.condition.PatternsRequestCondition patternsRequestCondition =
                new org.springframework.web.servlet.mvc.condition.PatternsRequestCondition(array);
    ...
    public RequestHandlerKey key() {
        ...
        if (requestMapping.getPatternsCondition() != null) {
            pattern = requestMapping.getPatternsCondition().getPatterns();
        } else if (requestMapping.getPathPatternsCondition() != null) {
            pattern = requestMapping.getPathPatternsCondition().getPatternValues();
        }
