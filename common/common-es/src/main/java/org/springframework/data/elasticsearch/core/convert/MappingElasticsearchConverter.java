...
public class MappingElasticsearchConverter
    ...
    protected <R> R readEntity(ElasticsearchPersistentEntity<?> entity, Map<String, Object> source) {
        ...
        ElasticsearchPersistentEntity<?> targetEntity = entity;


        if (!targetEntity.requiresPropertyPopulation()) {
            return (R) instantiators.getInstantiatorFor(targetEntity).createInstance(targetEntity,
                    new PersistentEntityParameterValueProvider<>(targetEntity, new ElasticsearchPropertyValueProvider(
                            new MapValueAccessor(source)), null));
        }

        TypeInformation<?> typeInformation = targetEntity.getTypeInformation();
        ...
        R result = readProperties((Class<R>) type, source);
    ...
    protected static class MapValueAccessor {
    ...
    protected class ElasticsearchPropertyValueProvider implements PropertyValueProvider<ElasticsearchPersistentProperty> {
        ...
        public Map<String, Object> getAsMap() {
            return mapValueAccessor.getTarget();
        }
