 ...
 * for update 插件
 */
public class SelectOneByExampleForUpdatePlugin extends BasePlugin {
    public static final String METHOD_SELECT_ONE_BY_EXAMPLE = "selectOneByExampleForUpdate";  // 方法名
    public static final String METHOD_SELECT_ONE_BY_EXAMPLE_WITH_BLOBS = "selectOneByExampleWithBLOBsForUpdate";  // 方法名
