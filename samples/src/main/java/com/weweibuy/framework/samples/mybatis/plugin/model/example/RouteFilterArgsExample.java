...
public class RouteFilterArgsExample {
    ...
    public RouteFilterArgsExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public RouteFilterArgsExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        RouteFilterArgsExample example = new RouteFilterArgsExample();
        return example.createCriteria();
    }

    public RouteFilterArgsExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public RouteFilterArgsExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private RouteFilterArgsExample example;

        protected Criteria(RouteFilterArgsExample example) {
            super();
            this.example = example;
        }

        public RouteFilterArgsExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.weweibuy.framework.samples.mybatis.plugin.model.example.RouteFilterArgsExample example);
    }
}