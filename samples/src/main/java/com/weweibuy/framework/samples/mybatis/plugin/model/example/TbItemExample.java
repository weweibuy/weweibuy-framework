...
public class TbItemExample {
    ...
    public TbItemExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public TbItemExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public TbItemExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public TbItemExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
    ...
    public interface IExampleWhen {
        void example(com.weweibuy.framework.samples.mybatis.plugin.model.example.TbItemExample example);
    }
}