...
(
   ...
   method_args          varchar(8000) not null default '' comment '方法参数',
...
drop index idx_compensate_id on compensate_method_args_ext;

drop table if exists compensate_method_args_ext;
...
alter table compensate_method_args_ext comment '补偿表方法参数扩展表';

/*==============================================================*/
/* Index: idx_compensate_id                                     */
/*==============================================================*/
create index idx_compensate_id on compensate_method_args_ext
(
   compensate_id
);
